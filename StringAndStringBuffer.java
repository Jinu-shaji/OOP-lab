...
class StringAndStringBuffer
 {
	...
	{
	StringBuffer s = new StringBuffer("jinu");
		int p = s.length();
		int q = s.capacity();
		System.out.println("Length of string Jinu=" + p);
		System.out.println("Capacity of string Jinu=" + q);
    s.append(" Shaji");
    System.out.println("After Appending="+s);
    s.insert(6, "-");
    System.out.println("After inserting - @possition 4="+s);
    s.reverse();
